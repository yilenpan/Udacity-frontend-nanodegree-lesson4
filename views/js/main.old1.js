...
Array.prototype.sample = function(){
  var sample = this[parseInt(Math.random() * this.length)];
  return sample;
};
...
function getAdj(x){
  switch(x) {
    ...
    case "whimsical":
      return whimsy.sample();
    case "shiny":
      return shiny.sample();
    case "noisy":
      return noisy.sample();
    case "apocalyptic":
      return apocalyptic.sample();
    case "insulting":
      return insulting.sample();
    case "praise":
      return praise.sample();
    case "scientific":
      return scientific.sample();
    default:
      return scientific_default.sample();
  }
}
...
function getNoun(y) {
  switch(y) {
    ...
    case "profession":
      return professions.sample();
    case "fantasy":
      return fantasy.sample();
    case "music":
      return music.sample();
    case "horror":
      return horror.sample();
    case "gross":
      return gross.sample();
    case "everyday":
      return everyday.sample();
    case "jewelry":
      return jewelry.sample();
    case "places":
      return places.sample();
    case "scifi":
      return scifi.sample();
    default:
      return scifi_default.sample();
  }
}
